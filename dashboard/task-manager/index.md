...
faq:
  ...
  - q: "Does the task editor have autocomplete?"
    a: "Yes. Click CTRL+SPACE on Windows or FN+CONTROL+SPACE on a Mac while editing a task, and choose from the list of slots that exist in your cloudlet."
  - q: "How do I run a task immediately?"
    a: "Click Execute on the task - either from the Task Manager, or from the Tasks section on the dashboard's landing page."
