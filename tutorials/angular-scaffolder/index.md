...
* _"base"_ - These are common base classes, from which most of the scaffolded modules will inherit from
* _"components"_ - This folder will contain one folder for every CRUD endpoint group, wrapping your table with CRUD operations
* _"helpers"_ - These are helper components, you can use as you wish, as you extend the Angular result Magic gives you
* _"pipes"_ - These are pipes, allowing you to perform transformation inside of your HTML files
* _"services"_ - These are the services your app relies upon
...
Angular project - Which might vary, according to what components you wish to have
...
one of its nifty little details, is the way it wires up `distinctUntilChanged()` parts above, which
...
while editing, maybe create a `selector` component to encapsulate many 2 one relationships, etc.
...
```
 ...
 This allows you to consume the service as follows.
